...
def get_daily_stats():
    ...
    return {
        "today": {
            "date": today,
            "mileage": round(get_daily_mileage(today), 1)
        },
        "yesterday": {
            "date": yesterday,
            "mileage": round(get_daily_mileage(yesterday), 1)
        },
        "all_days": {day: round(stats["total_miles"], 1) for day, stats in daily_stats.items()}
    }
